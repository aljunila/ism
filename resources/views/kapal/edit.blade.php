        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form id="form_kapal" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-12">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="pendaftaran" name="pendaftaran" required value="{{$show->pendaftaran}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="no_akte" name="no_akte" required value="{{$show->no_akte}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="no_siup" name="no_siup" required value="{{$show->no_siup}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="dikeluarkan_di" name="dikeluarkan_di" required value="{{$show->dikeluarkan_di}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="selar" name="selar" required value="{{$show->selar}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="call_sign" name="call_sign" required value="{{$show->call_sign}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="galangan" name="galangan" required value="{{$show->galangan}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="konstruksi" name="konstruksi" required value="{{$show->konstruksi}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="type" name="type" required value="{{$show->type}}">
                                    </div>
                                </div>
                                 <hr>
                                <div class="mb-1 row">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="max_speed" name="max_speed" value="{{$show->max_speed}}"> 
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">Normal Speed</label>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="normal_speed" name="normal_speed" value="{{$show->normal_speed}}"> 
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">knot</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="min_speed" name="min_speed" value="{{$show->min_speed}}"> 
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">knot</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="bahan_bakar" name="bahan_bakar" value="{{$show->bahan_bakar}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="jml_butuh" name="jml_butuh" value="{{$show->jml_butuh}}"> 
                                    </div>
                                    <div class="col-sm-3">
                        ...
                        <div class="col-md-6">
                            <div class="col-12">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="loa" name="loa" value="{{$show->loa}}">
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="lbp" name="lbp" value="{{$show->lbp}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="lebar" name="lebar" value="{{$show->lebar}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="dalam" name="dalam" value="{{$show->dalam}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="summer_draft" name="summer_draft" value="{{$show->summer_draft}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="winter_draft" name="winter_draft" value="{{$show->winter_draft}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="draft_air_tawar" name="draft_air_tawar" value="{{$show->draft_air_tawar}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="tropical_draft" name="tropical_draft" value="{{$show->tropical_draft}}">
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">meter</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="isi_kotor" name="isi_kotor" value="{{$show->isi_kotor}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="bobot_mati" name="bobot_mati" value="{{$show->bobot_mati}}"> 
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="col-form-label" for="first-name">ton</label>
                                    </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="nt" name="nt" value="{{$show->nt}}"> 
                                    </div>
                                </div>
                                <hr>
                                <div class="mb-1 row">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="merk_mesin_induk" name="merk_mesin_induk" value="{{$show->merk_mesin_induk}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="tahun_mesin_induk" name="tahun_mesin_induk" value="{{$show->tahun_mesin_induk}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="no_mesin_induk" name="no_mesin_induk" value="{{$show->no_mesin_induk}}"> 
                                    </div>
                                </div>
                                 <hr>
                                <div class="mb-1 row">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="merk_mesin_bantu" name="merk_mesin_bantu" value="{{$show->merk_mesin_bantu}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="tahun_mesin_bantu" name="tahun_mesin_bantu" value="{{$show->tahun_mesin_bantu}}"> 
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="no_mesin_bantu" name="no_mesin_bantu" value="{{$show->no_mesin_bantu}}"> 
                                    </div>
                                </div>
                            </div>
                        </div>
