...
class Cuti extends Model
{
    ...
    protected $fillable = ['id', 'uid', 'id_perusahaan', 'id_karyawan', 'id_jabatan', 'id_m_cuti', 'note', 'tgl_mulai', 'tgl_selesai', 'jml_hari', 'id_pengganti', 'status', 'is_delete', 'created_by', 'created_date', 'changed_by', 'changed_date', 'approved_by', 'approved_date'];
