            ...
            { 
                ...
                render: function (data, type, row) {
                    let kode = @json($form->kode);
                        return `
                        <a href="/interview/pdf/${row.uid}" type="button" target="_blank" class="btn btn-icon btn-xs btn-flat-primary download" title="Cetak PDF">
                    ...
                    return `
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a type="button" href="/interview/edit/${row.uid}" class="dropdown-item resign-btn">Edit</a>
            ...
            <div class="card">
                <div class="card-header border-bottom">
                    ...
                    <div class="col-3">
                        ...
                        <a href="/interview/add/{{$form->kode}}" class="btn btn-primary btn-sm">Tambah Data</a>
                    </div>
                </div>
                <div class="card-body">
