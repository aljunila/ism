        ...
        columns: [
            ...
            { 
                ...
                render: function(data, type, row){
                    ...
                    // `;
                    return `
                    <a href="/karyawan/pdf/${row.uid}" type ="button" target="_blank" class="btn btn-warning btn-sm me-1" id="pdf-btn">Data Profil</a>
                    <a href="/laporan/crew/${row.id}/download-zip" class="btn btn-sm btn-success"> Download Dokumen</a>`;
                }
            }
        ],
