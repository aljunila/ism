...
class DetailPermintaan extends Model
{
    ...
    protected $fillable = ['id', 'uid', 'id_permintaan', 'id_barang', 'jumlah', 'ket', 'status', 'id_cabang', 'kode_po', 'procurement_channel', 'flow_stage', 'is_delete', 'created_by', 'created_date', 'changed_by', 'changed_date'];
