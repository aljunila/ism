        ...
        <div class="modal-content">
            ...
            <form id="form_proses" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="mb-1 row">
                        <div class="col-sm-3">
                            <label class="col-form-label">Ketersediaan</label>
                        </div>
                        <div class="col-sm-9">
            ...
            logTables[tableId] = $('#' + tableId).DataTable({
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function (data, type, row) {
                            return `
                                <button type="button" class="btn btn-sm btn-outline-primary proses-btn" data-id="${row.id}" data-id_kapal="${row.id_kapal}" data-flow-stage="${row.flow_stage || ''}">
                                    Proses
                                </button>
                            `;
                        }
