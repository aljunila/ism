   ...
   <script>
        ...
        $("#tambah").click(function () {
            ...
            <div class="mb-1 row field-item">
                ...
                <div class="col-sm-5">
                    <input type="text" name="personil[]" class="form-control"placeholder="Nama Personil"  required>
                </div>
                <div class="col-sm-5">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mb-1 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label" for="first-name">Personil Kerja </label>
