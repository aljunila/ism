        ...
        columns: [
            ...
            { 
                ...
                render: function (data, type, row) {
                        return `
                        <a href="/notulen/pdf/${row.uid}" type="button" class="btn btn-icon btn-xs btn-flat-primary download" title="Cetak PDF">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <div class="col-sm-8"><h4 class="card-title">Daftar Notulen Rapat Familiarisasi / Penyuluhan Manajemen Keselamatan </h4></div>
                        <div class="col-sm-4">
