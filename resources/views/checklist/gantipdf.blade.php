    ...
    <div>
        <table class="table-bordered" width="100%">
            ...
            <tr style="text-align: left;">
                <td colspan="6">Nama Kapal : {{$show->get_kapal()->nama}}</td>
            </tr>
            <tr style="text-align: left;">
                <td colspan="3" width="50%">Dari : {{$show->get_dari()->nama}}</td>
                <td colspan="3" width="50%">Kepada : {{$show->get_kepada()->nama}}</td>
            </tr>
            <tr style="text-align: left;">
                <td colspan="3" width="50%">Pelabuhan : {{$show->pelabuhan}}</td>
                <td colspan="3" width="50%">Hari : {{ \Carbon\Carbon::parse($show->date)->translatedFormat('l') }}</td>
            </tr>
            <tr style="text-align: left;">
                <td colspan="3" width="50%">Tanggal : {{ \Carbon\Carbon::parse($show->date)->format('d-m-Y') }}</td>
                <td colspan="3" width="50%">Jam : {{$show->jam}}</td>
            </tr>
            <tr>
                <td colspan="3" width="50%">Uraian</td>
                <td width="15%">Ya</td>
