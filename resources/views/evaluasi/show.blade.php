        ...
        columns: [
            ...
            { 
                ...
                render: function (data, type, row) {
                        return `
                        <a href="/evaluasi/edit/${row.uid}" type="button" class="btn btn-icon btn-xs btn-flat-success download" target="_blank" title="Cetak PDF">
            ...
            { 
                ...
                render: function (data, type, row) {
                    return ` ${row.evaluasi ?
                    `<a href="/evaluasi/pdf/${row.evaluasi}" type="button" class="btn btn-icon btn-xs btn-flat-primary download" target="_blank" title="Cetak PDF">
