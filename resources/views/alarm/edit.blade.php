                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="keterangan">
                                            ...
                                            <option value="Januari" @selected($show->ket=='Januari')>Januari</option>
                                            <option value="Februari" @selected($show->ket=='Februari')>Februari</option>
                                            <option value="Maret" @selected($show->ket=='Maret')>Maret</option>
                                            <option value="April" @selected($show->ket=='April')>April</option>
                                            <option value="Mei" @selected($show->ket=='Mei')>Mei</option>
                                            <option value="Juni" @selected($show->ket=='Juni')>Juni</option>
                                            <option value="Juli" @selected($show->ket=='Juli')>Juli</option>
                                            <option value="Agustus" @selected($show->ket=='Agustus')>Agustus</option>
                                            <option value="September" @selected($show->ket=='September')>September</option>
                                            <option value="Oktober" @selected($show->ket=='Oktober')>Oktober</option>
                                            <option value="November" @selected($show->ket=='November')>November</option>
                                            <option value="Desember" @selected($show->ket=='Desember')>Desember</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-10">
                                        <table class="table table-bordered table-striped" border="1">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control" name="periode[{{$ck->checklist_item_id}}]" value="{{$ck->periode}}"></td>
                                                <td><input type="text" class="form-control" name="uji_terakhir[{{$ck->checklist_item_id}}]" value="{{$ck->uji_terakhir}}"></td>
                                                <td><input type="text" class="form-control" name="uji_yad[{{$ck->checklist_item_id}}]" value="{{$ck->uji_yad}}"></td>
                                ...
                                <div class="mb-1 row">
                                    <div class="col-sm-2">
                                        <label class="col-form-label" for="first-name">Disetujui</label>
                                    </div>
                                    <div class="col-sm-10">
