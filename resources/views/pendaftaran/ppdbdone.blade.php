...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('/vuexy/app-assets/css/pages/page-misc.css')}}">
    <!-- END: Page CSS-->
            ...
            <div class="content-body">
                ...
                <div class="misc-wrapper">
                    <a class="brand-logo" href="index.html">
                        <img src="{{$sekolah->logo()}}" height="35px"/><br><h2 class="brand-text text-primary ms-1">{{$sekolah->nama}}</h2>
                    </a>
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Terima Kasih</h2>
                            <p class="mb-2">Data formulir Anda telah tersimpan, selanjutnya sekolah akan menginformasikan untuk proses selanjutnya</p><br>
                            @if($show->fee=='Y') 
                                <p class="mb-2">Berikut informasi mengenai biaya Pendaftaran</p>
