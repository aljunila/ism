            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        @if($value->file)
                            <a href="/prosedur/view-file/{{$value->uid}}" target="_blank" type="button" class="btn btn-success btn-sm">
                                <i data-feather='eye'></i> Lihat
                            </a>
                            <a href="/prosedur/download_file/{{$value->uid}}" download type="button" class="btn btn-danger btn-sm">
