    ...
    <div>
        <table class="table-bordered" width="100%">
            <tr>
                ...
                <td width="25%" style="text-align: center;" colspan="3"><b>{{$form->ket}}</b></td>
            </tr>
            <tr>
                <td>{{$form->pj}}</td>
        ...
        <table class="table-bordered" width="100%">
            ...
            @endphp
            <tr >
                <td colspan="3" style="text-align: left;" width="50%">{!!$ck->item!!}</td>
                <td style="text-align: center;" width="15%">
                   {{ $row['value'] == 1 ? 'Ya' : 'Tidak' }}
                </td>
                <td width="20%" style="text-align: left;" colspan="2">{{ $row['ket'] ?? '' }}</td>
            </tr>
            @endforeach
            <tr style="text-align: left;">
