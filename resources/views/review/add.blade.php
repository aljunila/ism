                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="no_review" name="no_review" required>
                                </div>
                            </div>
                            <div class="mb-1 row">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" id="tgl_review" name="tgl_review" required>
                                </div>
                            </div>
                            <!-- <div class="mb-1 row">
                                <div class="col-sm-2">
                            ...
                            <div class="mb-1 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label" for="first-name">Hasil review Nakhoda terhadap prosedur dan formulir dari Sistem Manajemen Keselamatan (SMK) :

                                    </label>
                                </div>
                                <div class="col-sm-10">
                                    <textarea class="form-control tinymce" id="hasil" name="hasil"></textarea>
                                </div>
                            </div>
                            <!-- <div class="mb-1 row">
                                <div class="col-sm-2">
                                    <label class="col-form-label" for="first-name">Tanggapan DPA terhadap hasil review Nakhoda :

                                    </label>
                                </div>
                                <div class="col-sm-10">
                                    <textarea class="form-control tinymce" id="ket" name="ket"></textarea>
                                </div>
                            </div> -->
                        </div>
