                    ...
                    <div class="row">
                        <div class="col-md-10 col-12">
                            <div class="card">
                                ...
                                @endif
									<form action="{{ url('pendaftaran/update', $show->id) }}" method="POST" enctype="multipart/form-data">
   						 			@csrf
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="name" name="name" required value="{{ $show->nama }}">
                                                    </div>
                                                </div>
                                                <div class="mb-1 row">
                                                    <div class="col-sm-3">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="form-check form-check-inline">
                                                            <input type="radio" class="form-check-input" id="fee" name="fee" value="Y" {{ $show->fee == 'Y' ? 'checked' : ''}} required>
                                                            <label class="form-check-label" for="inlineRadio1">Ya</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input type="radio" class="form-check-input" id="fee" name="fee" value="N" {{ $show->fee == 'N' ? 'checked' : ''}} required>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                    <input type="date" name="start_date" id="start_date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" required value="{{ $show->tgl_mulai }}"/>
                                                    </div>
                                                </div>
                                                <div class="mb-1 row">
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="date" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" name="end_date" required value="{{ $show->tgl_akhir }}"/>
                                                    </div>
                                                </div>
                                            </div>
