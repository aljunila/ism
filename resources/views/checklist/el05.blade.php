            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        @include('filter')
                        <div class="col-3">
                            @php if($form->kode=='el0505') { $tambah= 'parentadd'; } elseif($form->kode=='el0508') { $tambah='panasadd'; } else { $tambah='add'; } @endphp
                                <a href="/checklist/{{$tambah}}/{{$form->kode}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <div class="card-body">
