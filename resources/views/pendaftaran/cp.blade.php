            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">Daftar Calon Peserta</h4>
                    </div>
                        ...
                        <td class="demo-inline-spacing">
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton600">
                                <a href="/siswa/profil/{{$each->id}}" class="dropdown-item">Info</a>
                                <a href="/siswa/edit/{{$each->id}}" class="dropdown-item">Edit</a>
                                <a href="/cp/delete/{{$each->id}}" class="dropdown-item"> Hapus</a> 
                            </div>
                          </div>
								        </td> 
							        </tr>
