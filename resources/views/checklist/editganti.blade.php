                ...
                if (kapalID) {
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#id_dari').empty().append('<option value="">-- Pilih Karyawan --</option>');
                            $('#id_kepada').empty().append('<option value="">-- Pilih Karyawan --</option>');

                            $.each(data, function(key, value) {
                                $('#id_dari').append('<option value="'+ value.id +'">'+ value.nama +'</option>');
                                $('#id_kepada').append('<option value="'+ value.id +'">'+ value.nama +'</option>');
                            });
                        }
                    });
                } else {
                    ...
                    <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="pelabuhan" name="pelabuhan" required value="{{$show->pelabuhan}}">
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="jam" name="jam" value="{{$show->jam}}" required>
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="id_dari" id="id_dari"  class="form-control" required>
                                        @foreach($karyawan as $k)
                                            <option value="{{$k->id}}" @selected ($k->id == $show->id_dari)>{{$k->nama}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        @foreach($karyawan as $k)
                                            <option value="{{$k->id}}" @selected ($k->id == $show->id_kepada)>{{$k->nama}}</option>
                                        @endforeach
                                        </select>
                                    </div>
                                </div>
