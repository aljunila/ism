        ...
        columns: [
            ...
            { 
                ...
                render: function (data, type, row) {
                        return `
                        <a href="/alarm/pdf/${row.uid}" type="button" class="btn btn-icon btn-xs btn-flat-primary download" target="_blank" title="Cetak PDF">
                    ...
                    return `
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a type="button" href="/alarm/edit/${row.uid}" class="dropdown-item resign-btn">Edit</a>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        @include('filter')
                        <div class="col-3">
                                <a href="/alarm/add/{{$form->kode}}" class="btn btn-primary btn-sm">Tambah Data</a>
                        </div>
                    </div>
                    <div class="card-body">
