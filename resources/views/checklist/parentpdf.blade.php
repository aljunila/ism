    ...
    <div>
        <table class="table-bordered" width="100%">
            ...
            <tr style="text-align: left;">
                <td colspan="3">Tanggal Pemeriksaan : {{ \Carbon\Carbon::parse($show->date)->format('d-m-Y') }}</td>
            ...
            <tr>
                <td colspan="4">Jenis Pemeriksaan</td>
                <td>Ya</td>
                <td>Tidak</td>
            </tr>
            @foreach($item as $ck)
            ...
            @endforeach
            <tr>
                <td colspan="4" style="text-align: left;">Catatan kelainan pada pengukuran maupun observasi sbb</td>
                <td colspan="2">{!!$ck->ket!!}</td>
            </tr>
            @endforeach
            <tr>
