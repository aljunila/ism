                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="npwp" name="npwp" required value="{{ $show->npwp }}">
                                </div>
                            </div>
                            <div class="mb-1 row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" id="nib" name="nib" required value="{{ $show->nib }}">
                                </div>
                            </div>
                            <div class="mb-1 row">
                                <div class="col-sm-3">
