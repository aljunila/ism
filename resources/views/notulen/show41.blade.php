            ...
            columns: [
                ...
                { 
                    ...
                    render: function (data, type, row) {
                        return `
                            <a href="/notulen/pdf41/${row.id_perusahaan}/${row.tahun}" target="_blank" class="btn btn-icon btn-xs btn-flat-primary download" 
                                title="Cetak PDF"><i data-feather='printer'></i>
                            </a>
                        `;
                    }
                },
